    ...
    <div className="w-full flex gap-5 h-screen bg-zinc-900 p-20">
      <div className="w-1/2 h-full flex flex-col justify-between font-[Founders Grotesk]">
        <div className="heading">
          <h1 className="text-[6vw] font-semibold uppercase leading-none -mb-10 tracking-tighter">
            Eye-
          </h1>
          <h1 className="text-[6vw] font-semibold uppercase leading-none -mb-10 tracking-tighter mt-6">
            Opening
          </h1>
        </div>
        <svg
